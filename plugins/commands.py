...
async def start(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🎖️ʜᴇʟᴘ🎖️", callback_data="help_data"),
                    InlineKeyboardButton("Our~Links", url="https://t.me/PrimeFlixMedia_All")
                ]
            ]
        ),
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("мα-¢нαηηєℓ", url="https://t.me/PrimeFlixMeda_All")
                ],
                [
                    InlineKeyboardButton("ɢʀᴏᴜᴘ", url="https://t.me/PrimeFlix_Chats"),
                    InlineKeyboardButton("ᴀʙᴏᴜᴛ-ᴍᴇ", callback_data="about_data")
                ],
                [
                    InlineKeyboardButtom("Back", callback_data="start_data")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "📋ѕσυя¢є-¢σ∂є📋", url="https://t.me/Oomban_ULLATH")
                ],
                [
